...
func (*ArticlesController) Create(w http.ResponseWriter, r *http.Request) {
	...
	storeURL := Handler.Name2URL("articles.store")
...
func (*ArticlesController) Edit(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		// 4. 读取成功，显示编辑文章表单
		updateURL := Handler.Name2URL("articles.update", "id", id)
		data := ArticlesFormData{
			Title:  article.Title,
			Body:   article.Body,
			URL:    updateURL,
...
func (*ArticlesController) Update(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		if len(errors) == 0 {
			...
			// √ 更新成功，跳转到文章详情页
			if rowsAffected > 0 {
				showURL := Handler.Name2URL("articles.show", "id", id)
...
func (*ArticlesController) Index(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		tmpl.ExecuteTemplate(w, "myapp", articles)
	}
}
...
func (*ArticlesController) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		if err != nil {
			...
			if rowsAffected > 0 {
				// 重定向到文章列表页
				indexURL := Handler.Name2URL("articles.index")
